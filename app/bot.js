...
client.on("guildMemberAdd", member => {
  member.roles.add('808009439084281876'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
});
      ...
      if(üs) {
        üyesayısı = üyesayısı.replace(/([0-9])/g, d => {
          return {
            ...
            '8': `8`,
            '9': `9`}[d];})}
      const kanal = member.guild.channels.cache.find(r => r.id === "808008607693930499");//mesaj atılcak kanal id
