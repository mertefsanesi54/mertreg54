...
const tag = 'STRG'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '808010395989573632') //erkek rol id
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '808010395989573632')//erkek rol 2 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '808009439084281876')//kayıtsız id
const genelchat = message.guild.channels.cache.find(c => c.id === '808008607693930499')//genelchat id
