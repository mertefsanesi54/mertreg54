...
const tag = 'STRG'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '808010394395213844') //kadın rol id
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '808010394395213844')//kadın rol2 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '808009439084281876')//kayıtsız rol id
const genelchat = message.guild.channels.cache.find(c => c.id === '808008607693930499')//genel chat id
const savelog = message.guild.channels.cache.find(c => c.id === '808008607693930499')//savelog id
